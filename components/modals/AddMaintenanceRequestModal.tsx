  ...
  return (
    <BaseModal title={`New Maintenance Request for Lot #${property.lotNumber}`} onClose={onClose}>
      <form onSubmit={handleSubmit} className="p-6 space-y-6 bg-white text-black">
        ...
        <div>
          <h3 className="text-lg font-medium text-black">Issues *</h3>
          <p className="text-sm text-gray-800">Please check all that apply.</p>
          <div className="mt-4 space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 mt-2">
                  {subIssues.map(issue => (
                    <label key={issue} className="flex items-center">
                      ...
                      <span className="ml-2 text-sm text-black">{issue}</span>
                    </label>
                  ))}
                </div>
              </div>
            ...
            <div>
              <h4 className="font-semibold text-black">Other</h4>
        ...
        <div>
          <label className="block text-sm font-medium text-black">Description of the Issue *</label>
        ...
        <div>
          <label className="block text-sm font-medium text-black">When did the issue start? *</label>
        ...
        <div>
          <h3 className="text-sm font-medium text-black">Level of Urgency *</h3>
        ...
        <div>
          <h3 className="text-sm font-medium text-black">Authorization to Enter Without Tenant Present? *</h3>
          <div className="mt-2 flex space-x-4">
